...
export function PublicPageRenderer({ data }: PublicPageRendererProps) {
  const { profile, page, links, settings } = data;
  ...
  return (
    <>
      <TrackingProvider slug={page.slug}>
        {/* ── PAGE WRAPPER ── */}
        <div className="min-h-dvh bg-[#F0EFEB]">
          <main className="mx-auto max-w-[480px] px-4 pt-10 pb-16">
            ...
            {/* ── FOOTER SOCIAL ICONS ── */}
            <footer className="mt-10 flex items-center justify-center gap-7">
              {/* Instagram */}
